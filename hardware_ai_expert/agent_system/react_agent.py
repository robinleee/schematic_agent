    ...
    def _build_system_prompt(self, task_type_hint: str = "") -> str:
        ...
        if task_type_hint == "review":
            ...
            task_guidance = (
                ...
                "The user has a hardware failure. Recommended approach:\n"
                "1. Form an initial hypothesis based on the symptom\n"
                "2. Use graph tools (get_power_tree, get_component_nets, etc.) to gather evidence\n"
                "3. Search knowledge base for known failure patterns\n"
                "4. Update hypothesis confidence based on observations\n"
                "5. Output final diagnosis with root cause and recommendations\n"
            )
